...
const Banner = () => {
    return (
        <div className="bg-purple-50 px-5 lg:px-0 py-10 lg:py-20">
           <div className="animate__animated animate__fadeIn container mx-auto flex flex-col-reverse lg:flex-row items-center justify-evenly gap-20">
             <div className="space-y-3 text-center lg:text-left">
                <h1 className="font-bold text-2xl lg:text-5xl uppercase text-purple-400 ">Healthy Animals,</h1>
                <h1 className="font-bold text-orange-300 text-2xl lg:text-5xl uppercase"> Hassle-Free Qurbani </h1>
                <h1 className="mt-5 lg:text-2xl font-bold uppercase">Best Deals on Qurbani Animals <br /> & Care Supplies!</h1>
